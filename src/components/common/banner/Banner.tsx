  ...
  return (
    ...
    >
      <div className="flex font-semibold flex-col w-fit items-center">
        <h1 className="text-[6rem] font-semibold max-sm:text-[2.5rem] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-500 inline-block text-transparent bg-clip-text capitalize">
          {"find your"}
        ...
        <h1 className="text-[4rem] mt-[-25px] bg-gradient-to-r from-slate-900 via-slate-800 to-slate-300/10 inline-block text-transparent bg-clip-text">
          {"Easy and Fast."}
        </h1>
        <p
