  ...
  return (
    ...
    >
      <div className="flex font-semibold flex-col w-fit items-center">
        <h1 className="text-[6rem] max-2xl:text-[5rem] max-lg:text-[4rem] max-md:text-[3.5rem] max-md:text-center max-sm:text-[2.5rem] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-500 inline-block text-transparent bg-clip-text capitalize">
          {"find your"}
          <span className="bg-gradient-to-b from-sky-600 via-sky-400 to-sky-300 inline-block text-transparent bg-clip-text ml-4">
            {"job"}
          </span>
        </h1>
        <h1 className="text-[6rem] max-2xl:text-[5rem] max-md:text-[3.5rem] max-sm:text-[2.25rem] max-md:text-center bg-gradient-to-t from-slate-900 via-slate-800 to-slate-500 inline-block text-transparent bg-clip-text">
          {"Easy and Fast."}
        </h1>
        <p
